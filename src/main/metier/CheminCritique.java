...
public class CheminCritique {
    ...
    public void ajouterTache(Tache tache) {
        if (tache != null) { // La vérification .estCritique() est faite en amont dans Mpm
            this.tachesCritiques.add(tache);
        }
    }

    public List<Tache> getTachesCritiques() {
        return new ArrayList<>(this.tachesCritiques); // Retourne une copie pour éviter modification externe
    }

    public void setDureeTotale(int duree) {
